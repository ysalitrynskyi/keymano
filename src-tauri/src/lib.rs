...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_snapshot_with_options,
            commands::get_xml,
            commands::validate,
            commands::validation_report,
            commands::repair_plan,
            commands::apply_repair_plan,
            commands::layer_matrix,
            commands::dead_key_graph,
            commands::comments,
            commands::set_comments,
            commands::bundle_metadata,
            commands::set_bundle_metadata,
            commands::repair,
            ...
            commands::set_key_output_in_map,
            commands::clear_key,
