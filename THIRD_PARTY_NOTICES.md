...
`KeyboardLayout.dtd`. Keymano's format compatibility is also informed by the
behaviour of the open-source [Ukelele](https://software.sil.org/ukelele/)
project by John Brownie / SIL International. No Apple or Ukelele code is
included in Keymano; only the externally observable file format is mirrored.
