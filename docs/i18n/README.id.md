...
- Editor visual — klik tombol apa pun untuk mengatur keluarannya untuk kombinasi modifier dan status dead-key apa pun
- Dead key, terminator, dan peta modifier
- Geometri keyboard fisik ANSI / ISO / JIS
- Membaca dan menulis XML `.keylayout` asli Apple serta paket `.bundle`
...
*Keymano adalah proyek independen, tidak berafiliasi dengan Apple atau SIL International. "Apple", "macOS", dan "Ukelele" adalah merek dagang pemiliknya masing-masing.*
