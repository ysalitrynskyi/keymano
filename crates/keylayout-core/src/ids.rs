//! Keyboard `id` / `group` script ranges + random id generation (docs/12 §1).
//!
...
impl Script {
    ...
    ///
    /// All listed scripts use group 0 (docs/12 §1); the distinguishing factor
...
/// Lenient check for VALIDATING existing files. Real Apple/Ukelele layouts use
