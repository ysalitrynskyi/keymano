//! New-keyboard templates (docs/12 §2). Constructors assign a random valid id.
//!
...
/// The basic starter modifier map (docs/12 §2).
...
/// JIS set relative to ANSI (docs/12 §4 RepairJIS-friendly).
